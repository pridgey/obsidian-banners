...
export default class SettingsTab extends PluginSettingTab {
  ...
  async saveSettings(
    changed: Partial<SettingsOptions>,
    { reloadSettings = false, refreshViews = false } = {}
  ) {
  ...
  display() {
    ...
    new Setting(containerEl)
      .setName("Show Title")
      .setDesc("Show Title on the banner")
      .addToggle((toggle) =>
        toggle
          .setValue(showTitle)
          .onChange(async (val) =>
            this.saveSettings({ showTitle: val }, { refreshViews: true })
          )
      );
  }
